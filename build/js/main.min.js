...
/* harmony import */ var _modules_accordions_init_accordion__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/accordions/init-accordion */ "./js/modules/accordions/init-accordion.js");
/* harmony import */ var _modules_expand_buttons_init_expand_buttons__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/expand-buttons/init-expand-buttons */ "./js/modules/expand-buttons/init-expand-buttons.js");
...
/* harmony import */ var _utils_ios_vh_fix__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/ios-vh-fix */ "./js/utils/ios-vh-fix.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_utils_ios_vh_fix__WEBPACK_IMPORTED_MODULE_4__["iosVhFix"])();
  ...
  window.addEventListener('load', function () {
    Object(_modules_accordions_init_accordion__WEBPACK_IMPORTED_MODULE_0__["initAccordions"])();
    Object(_modules_expand_buttons_init_expand_buttons__WEBPACK_IMPORTED_MODULE_1__["initExpandButtons"])();
...
/*!*****************************************************!*\
  !*** ./js/modules/expand-buttons/expand-buttons.js ***!
  \*****************************************************/
/*! exports provided: ExpandButtons */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ExpandButtons", function() { return ExpandButtons; });
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var ExpandButtons = /*#__PURE__*/function () {
  function ExpandButtons() {
    _classCallCheck(this, ExpandButtons);
    this.init();
  }
  _createClass(ExpandButtons, [{
    key: "init",
    value: function init() {
      var _this = this;
      var closedElements = document.querySelectorAll('[data-expand="element"]');
      closedElements.forEach(function (closedElement) {
        _this.setAttr(closedElement);
        _this.setClasses(closedElement);
        _this.setListeners(closedElement);
      });
    }
  }, {
    key: "setAttr",
    value: function setAttr(element) {
      var hiddenTextsForAllVp = element.querySelectorAll('[data-visibility="is-hidden"]');
      var hiddenTextsForMobile = element.querySelectorAll('[data-visibility="is-hidden-for-mobile"]');
    ...
    value: function setClasses(element) {
      var hiddenTexts = element.querySelectorAll('[data-visibility="is-hidden"], [data-visibility="is-hidden-for-mobile"]');
      var buttonTextShown = element.querySelector('[data-expand="text-shown"]');
    ...
    key: "setListeners",
    value: function setListeners(element) {
      var hiddenTexts = element.querySelectorAll('[data-visibility="is-hidden"], [data-visibility="is-hidden-for-mobile"]');
      var expandButton = element.querySelector('[data-expand="button"]');
      var buttonTextHidden = element.querySelector('[data-expand="text-hidden"]');
      var buttonTextShown = element.querySelector('[data-expand="text-shown"]');
...
/*!**********************************************************!*\
  !*** ./js/modules/expand-buttons/init-expand-buttons.js ***!
  \**********************************************************/
/*! exports provided: initExpandButtons, expandButtons */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initExpandButtons", function() { return initExpandButtons; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "expandButtons", function() { return expandButtons; });
/* harmony import */ var _expand_buttons__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./expand-buttons */ "./js/modules/expand-buttons/expand-buttons.js");

var expandButtons;
var initExpandButtons = function initExpandButtons() {
  expandButtons = new _expand_buttons__WEBPACK_IMPORTED_MODULE_0__["ExpandButtons"]();
};
...
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api */ "./js/modules/form-validate/api.js");
/* harmony import */ var _message__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./message */ "./js/modules/form-validate/message.js");


var baseSuccessCallback = function baseSuccessCallback(event) {
  event.preventDefault();
  Object(_api__WEBPACK_IMPORTED_MODULE_0__["sendData"])(function () {
    return Object(_message__WEBPACK_IMPORTED_MODULE_1__["showMessage"])('success');
  }, function () {
    return Object(_message__WEBPACK_IMPORTED_MODULE_1__["showMessage"])('error');
...
/***/ "./js/modules/form-validate/message.js":
/*!*********************************************!*\
  !*** ./js/modules/form-validate/message.js ***!
  \*********************************************/
...
function showMessage(type) {
  messageElement = document.querySelector("#".concat(type)).content.querySelector('div').cloneNode(true);
